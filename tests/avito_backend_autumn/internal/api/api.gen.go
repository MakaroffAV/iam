...
func (siw *ServerInterfaceWrapper) EditBid(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithLocation("simple", false, "bidId", runtime.ParamLocationPath, chi.URLParam(r, "bidId"), &bidId)
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetBidsForTender(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithLocation("simple", false, "tenderId", runtime.ParamLocationPath, chi.URLParam(r, "tenderId"), &tenderId)
	if err != nil {
